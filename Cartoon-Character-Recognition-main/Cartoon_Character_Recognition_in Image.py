...
ap.add_argument("-p", "--path", type=str, default="Data/Spongebob.jpg", help="path to image")
...
org = (10, 50) # origin or starting point for rendering text on an image using OpenCV. It is a tuple that contains the x and y coordinates (in pixels) where the text should be placed on the image.
fontScale = 1
color = (0, 0, 0) 
thickness = 2
...
smallImg=cv.imread('Data/'+class_dict[predict]+'.jpg')
